...
###################################################
		...
		#panel name - CAKUT works / Dys fails
		#AU_251_Congenital_abnormalities_of_the_kidneys_and_urinary_tract_(CAKUT)_SuperPanel
		each_version_file = "%s_v%s(%s)_Annotated_PA-%s.tsv" % (panel_name_Y, version_processed, panel_id, source)
		#Congenital_abnormalities_of_the_kidneys_and_urinary_tract__v0.30(251)_Annotated_PA-AU.tsv
		#Congenital_abnormalities_of_the_kidneys_and_urinary_tract_(CAKUT)_SuperPanel_v0.30(251)_Annotated_PA-AU.tsv	
